...
{assign var="element_name" value=$element.element_name}
    ...
    {else}
            ...
            <td class="label">{$form.$field_element.label}{if $element.help_post}{help id=$element.id file="CRM/Custom/Form/CustomField.hlp" title=$element.label}{/if}</td>
            <td class="html-adjust">
                {$form.$field_element.html}&nbsp;
